...
public class KidsWear {
	...
	public String toString() {
		return "KidsWear [hid=" + hid + ", hname=" + hname + ", hprice=" + hprice + ", descr=" + descr + ", hdiscount="
				+ hdiscount + "]";
	}

	public KidsWear(int hid, String hname, double hprice, String descr, String hdiscount) {
		super();
		this.hid = hid;
		this.hname = hname;
		this.hprice = hprice;
