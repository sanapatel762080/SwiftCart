...
public class MensFashion {
		...
		public String toString() {
			return "MensFashion [hid=" + hid + ", hname=" + hname + ", hprice=" + hprice + ", descr=" + descr + ", hdiscount="
					+ hdiscount + "]";
		}

		public MensFashion(int hid, String hname, double hprice, String descr, String hdiscount) {
			super();
			this.hid = hid;
			this.hname = hname;
			this.hprice = hprice;
